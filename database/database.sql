...
(
    ...
    runtime integer,
    rating integer,
    mpaa_rating character varying COLLATE pg_catalog."default",
    created_at timestamp without time zone,
    updated_at timestamp without time zone,
    poster character varying COLLATE pg_catalog."default", -- Добавленный столбец
    CONSTRAINT movies_pkey PRIMARY KEY (id)
    )

ALTER TABLE public.movies ADD COLUMN poster character varying COLLATE pg_catalog."default";
...
INSERT INTO public.genres (id, genre_name, created_at, updated_at) VALUES
...
INSERT INTO public.movies (id, title, description, year, release_date, runtime, rating, mpaa_rating, created_at, updated_at) VALUES
...
(1, 1, 1, '2021-05-17 00:00:00', '2021-05-17 00:00:00'),
(2, 2, 1, '2021-05-17 00:00:00', '2021-05-17 00:00:00'),
(3, 4, 2, '2021-05-17 00:00:00', '2021-05-17 00:00:00'),
(4, 3, 3, '2021-05-17 00:00:00', '2021-05-17 00:00:00');
