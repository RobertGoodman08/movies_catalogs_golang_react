...
// Функция-обработчик для получения отдельного фильма по его ID
...
// Получение всех фильмов по указанному жанру
...
// Добавление и редактирование фильма
